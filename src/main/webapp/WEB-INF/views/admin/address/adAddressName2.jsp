...
<head>
  <meta charset="UTF-8">
  <title>adAddressName2.jsp</title>
  ...
  <script>
    ...
    function addressSearch() {
    	...
    	location.href = "${ctp}/admin/adAddressName2?address="+address;
    }
    ...
    function addressDelete() {
    	...
    	$.ajax({
    		type : "post",
    		url  : "${ctp}/admin/adAddressDelete",
    		data : {address : address},
    		success:function() {
    			alert("DB에 저장된 지역명이 삭제되었습니다.");
    			location.href="${ctp}/admin/adAddressName2";
    		},
    		error : function() {
    			alert("전송오류!");
    		}
	...
	<div>
	  <form name="myForm" method="post">
	    <div>
	      ...
	      <input type="button" value="지역 검색" onclick="addressSearch()"/>
	      <input type="button" value="지역명 DB에서삭제" onclick="addressDelete()"/>
	    </div>
	  </form>
	</div>
  <hr/>
