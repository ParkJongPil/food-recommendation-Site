	...
	<table class="table" style="width:80%; height:400px;">
		...
		<c:if test="${not empty iVo.restaurantSite}">
			<tr style="font-size:16px; color:black;">
				...
				<td><a href="#" onclick="location.href='${iVo.restaurantSite}';"></a></td> 
			</tr>
		</c:if>
...
<hr/>
	...
	<!--작성된 리뷰 보여주기  -->
	<div style="width: 45%;margin-top: 20px; margin-left: 20%; justify-content: space-evenly;">
  ...
  <table><tr><td>
	<div id="map" class="row" style="border: 1px solid blue;width: 29%;height: 410px;margin-left: 1330px;display: flex;margin-top: -913px; flex-wrap: wrap; position: absolute;">
		<h2>지도</h2>
		<div  style="border: 1px solid blue; width: 101%; height: 410px; margin-left: 0%; margin-top: 70%; padding-top: 30px">
			<h2>주변 인기 식당</h2>
			<c:forEach var="vo" items="${searchVos}">
				<div>매장 이름: ${vo.restaurantName}</div>
				<div>${vo.FSName}</div>
			</c:forEach>
		</div>
		<c:if test="${not empty iVo.hashTag}">
			<div  style="border: 1px solid blue; width: 101%; height: 410px; margin-left: 0%; margin-top: 6%; padding-top: 30px">
				<h2>이 식당 관련태그</h2>
					<tr>
						<td>
