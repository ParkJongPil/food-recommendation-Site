...
<%-- 		 <span style="z-index: 99px; border-radius:25px; background-color:white; color:black;">. ${rCount} .</span> --%>
					<span style="color:white">
					<c:if test="${sMid == null}">
						<button type="button" onclick="document.getElementById('id01').style.display='block'" style="border: 0px; border-radius: 50%; color: white; background-color: #ff792a; width:28px;">0</button>
					</c:if>
						<button type="button" onclick="document.getElementById('id01').style.display='block'" style="border: 0px; border-radius: 50%; color: white; background-color: #ff792a; width:28px;">${rCount}</button>
					</span>
		    </div>
	    </c:if>
	    ...
	    <div class="subnav-content" style="z-indx:99;">
				...
				<c:if test="${sLevel == 0 || sLevel == 1}">
					...
					<b><a class="w3-bar-item w3-padding-large w3-hide-small w3-right" href="${ctp}/member/memLogin">회원탈퇴</a></b>
		...
		<a class="w3-bar-item w3-padding-large w3-hover-none w3-hide-small w3-right" href="${ctp}/">망고 스토리</a>
		<a class="w3-bar-item w3-padding-large w3-hover-none w3-hide-small w3-right" href="${ctp}/restaurantTopList">맛집 리스트</a>
		<a class="w3-bar-item w3-padding-large w3-hover-none w3-hide-small w3-right" href="${ctp}/">EAT딜</a>
